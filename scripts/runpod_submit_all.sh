...
# ============================================================
# RunPod: main IQL experiments (PPF methods).
# Mirrors submit_all.sh but runs directly on the pod
...
NOTEBOOK_DIR="$PROJECT_ROOT/notebooks/main"
...
GPU_ID="${GPU_ID:-0}"
FORCE_RERUN="${FORCE_RERUN:-0}"   # set to 1 to re-run jobs whose output already exists
...
echo
echo "[$(timestamp)] All main IQL jobs finished for ENV_NAME=$ENV_NAME"
