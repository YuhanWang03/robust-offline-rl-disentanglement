...
# ============================================================
# RunPod: B1 ablation — remove privileged supervision.
...
NOTEBOOK_DIR="$PROJECT_ROOT/notebooks/ablation_noisy_target"
...
echo
echo "[$(timestamp)] All B1 (no_priv) jobs finished for ENV_NAME=$ENV_NAME"
