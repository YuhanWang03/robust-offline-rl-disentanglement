...
# ============================================================
# RunPod: true_only baseline (seed sweep only, no noise).
# Mirrors submit_true_only.sh but runs directly on the pod.
#
...
echo
echo "[$(timestamp)] All true_only jobs finished for ENV_NAME=$ENV_NAME"
