...
# ============================================================
# RunPod: External comparison methods from literature:
...
# Mirrors submit_external_methods.sh but runs directly on
# the pod without Slurm / sbatch.
#
...
NOTEBOOK_DIR="$PROJECT_ROOT/notebooks/external_methods"
...
echo
echo "[$(timestamp)] All external method jobs finished for ENV_NAME=$ENV_NAME"
