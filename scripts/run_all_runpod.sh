...
# ============================================================
# RunPod single-GPU serial runner
# - Executes notebooks directly on the current Pod
# - Keeps your current notebook-based workflow
# - No Slurm / sbatch
# ============================================================
...
# Basic config
# ----------------------------
ENV_NAME="${ENV_NAME:-ant-medium-v2}"
...
if [[ -n "${NOISE_DIMS_STR:-}" ]]; then read -ra NOISE_DIMS <<< "$NOISE_DIMS_STR"; fi  # e.g. NOISE_DIMS_STR="28"
...
# Make sure the kernel exists for nbconvert execution
...
echo "[$(timestamp)] CONDA_ENV_NAME=$CONDA_ENV_NAME"
...
echo "[$(timestamp)] All RunPod jobs finished for ENV_NAME=$ENV_NAME"